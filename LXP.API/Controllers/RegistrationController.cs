...
namespace LXP.Api.Controllers
{
    ...
    public class RegistrationController : BaseController
    {
        ...
        {
            var learnerWithProfile = await _learnerServices.GetLearnerById(id);
        ...
        public IActionResult GenerateOTP([FromQuery] string email)
        {
            ...
            string sender = "rajkumar.ramanathan@relevant.com"; // Replace with your Gmail address
            string senderPass = "RajGomathi0828*&"; // Replace with your Gmail password
