...
namespace LXP.Core.Services
{
    public class LearnerProgressService : ILearnerProgressService
    {
        ...
        public LearnerProgressService(ILearnerProgressRepository learnerProgressRepository, IMaterialRepository materialRepository, ICourseTopicRepository courseTopicRepository, IEnrollmentRepository enrollmentRepository)
        {
